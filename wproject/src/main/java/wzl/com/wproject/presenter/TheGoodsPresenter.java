...
public class TheGoodsPresenter extends BasePresenter{
    public TheGoodsPresenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    public Observable observable(Object... args) {
        ...
        return login.confirmReceipt((int)args[0],(String) args[1],(String) args[2]);
    }
}
