...
public class InsideShowOrderAdapter_dsh extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<OrderBeans> list;
    private Activity activity;
    private LayoutInflater inflater;
    public InsideShowOrderAdapter_dsh(List<OrderBeans> list, Activity activity) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.insideshoworder_dsh_item,viewGroup,false);
